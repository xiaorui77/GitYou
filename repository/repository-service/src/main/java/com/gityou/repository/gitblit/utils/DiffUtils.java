...
import com.gityou.repository.gitblit.PatchFormatter;
...
public class DiffUtils {
     ...
     * @param comparator
     * @param outputType
     * @param handler    to use for rendering binary diffs if {@code outputType} is {@link DiffOutputType#HTML HTML}.
     ...
     *
     * @param repository
     * @param baseCommit     if base commit is null the diff is to the primary parent of
     *                       the commit.
     * @param commit
     * @param path           if the path is specified, the diff is restricted to that file
     ...
     *
     * @param repository
     * @param baseCommit if base commit is unspecified, the patch is generated against
     *                   the primary parent of the specified commit.
     * @param commit
     * @param path       if path is specified, the patch is generated only for the
