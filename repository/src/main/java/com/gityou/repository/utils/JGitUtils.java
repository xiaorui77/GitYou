...
import com.gityou.repository.gitblit.Constants.MergeType;
import com.gityou.repository.gitblit.DiffStatFormatter;
import com.gityou.repository.gitblit.GitBlitException;
import com.gityou.repository.gitblit.GitNote;
import com.gityou.repository.gitblit.PatchsetCommand;
import com.gityou.repository.gitblit.model.FilestoreModel;
import com.gityou.repository.gitblit.model.PathModel;
import com.gityou.repository.gitblit.model.PathModel.PathChangeModel;
import com.gityou.repository.gitblit.model.RefModel;
import com.gityou.repository.gitblit.model.SubmoduleModel;
import com.gityou.repository.gitblit.utils.*;
...
public class JGitUtils {
    ...
    public static boolean isPossibleFilestoreItem(long size) {
        return ((size >= com.gityou.repository.gitblit.Constants.LEN_FILESTORE_META_MIN)
                && (size <= com.gityou.repository.gitblit.Constants.LEN_FILESTORE_META_MAX));
    }
    ...
    public static FilestoreModel getFilestoreItem(ObjectLoader obj) {
        try {
            final byte[] blob = obj.getCachedBytes(com.gityou.repository.gitblit.Constants.LEN_FILESTORE_META_MAX);
    ...
    public static List<RevCommit> searchRevlogs(Repository repository, String objectId,
                                                String value, final com.gityou.repository.gitblit.Constants.SearchType type, int offset, int maxCount) {
        List<RevCommit> list = new ArrayList<RevCommit>();
    ...
    public static String getLfsRepositoryUrl(String baseURL, String repositoryName, String oid) {
        ...
        return baseURL + com.gityou.repository.gitblit.Constants.R_PATH
                + repositoryName + "/"
                + com.gityou.repository.gitblit.Constants.R_LFS
                + "objects/" + oid;
    ...
    public static boolean commitIndex(Repository db, String branch, DirCache index,
        ...
        try {
            ...
            commit.setEncoding(com.gityou.repository.gitblit.Constants.ENCODING);
            commit.setMessage(message);
