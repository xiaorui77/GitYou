...
import com.gityou.repository.gitblit.Constants.PermissionType;
...
public class RegistrantAccessPermission implements Serializable, Comparable<RegistrantAccessPermission> {
    ...
    public RegistrantAccessPermission(String registrant, Constants.AccessPermission permission, PermissionType permissionType, Constants.RegistrantType registrantType, String source, boolean mutable) {
